from dj.sql.parsing.backends.dj.generated.SqlBaseLexer import SqlBaseLexer
from dj.sql.parsing.backends.dj.generated.SqlBaseParser import SqlBaseParser
...
def string_to_ast(string, rule, *, strict_mode=False, early_bail=False):
...
def parse_sql(string, rule, converter):
    tree = string_to_ast(string, rule)
