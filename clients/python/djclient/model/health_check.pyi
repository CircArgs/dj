...
"""
    ...
    The version of the OpenAPI document: 0.0.post1.dev1+gdc24a04
...
class HealthCheck(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def status() -> typing.Type['HealthcheckStatus']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'HealthcheckStatus': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> 'HealthcheckStatus': ...
